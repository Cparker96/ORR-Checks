...
CLRVersion = '4.0'
AliasesToExport = @()
FunctionsToExport = @('Get-AzureCheck', 'Get-VMCheck','Get-ERPMAdminsCheck','Get-ERPMOUCheck','Get-McAfeeCheck','Get-TenableCheck','Scan-Tenable', 'Get-SplunkCheck', 'Splunk-Auth', 'Splunk-Result')
}
